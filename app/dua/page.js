...
const translations = {
  en: {
    ...
    subtitle: 'Prayers and Supplications',
    play: 'Play',
    pause: 'Pause',
    download: 'Download',
    noAudio: 'No Dua available yet',
    description: 'Dua is a form of supplication and prayer in Islam. These heartfelt prayers seek Allah\'s blessings, guidance, and mercy for ourselves and others.',
  },
  ur: {
    title: 'دعا - دعائیں',
    backToHome: 'واپس ہوم پیج',
    subtitle: 'دعائیں اور مناجات',
    play: 'چلائیں',
    pause: 'روکیں',
    download: 'ڈاؤن لوڈ',
    noAudio: 'ابھی کوئی دعا دستیاب نہیں',
    description: 'دعا اسلام میں مناجات اور پرارتھنا کی ایک شکل ہے۔ یہ دلی دعائیں اپنے اور دوسروں کے لیے اللہ کی برکتیں، رہنمائی اور رحمت طلب کرتی ہیں۔',
  },
  sd: {
    title: 'دعا - دعائون',
    backToHome: 'واپس گهر',
    subtitle: 'دعائون ۽ مناجات',
    play: 'هلايو',
    pause: 'روڪيو',
    download: 'ڊائون لوڊ',
    noAudio: 'هاڻي ڪا به دعا موجود ناهي',
    description: 'دعا اسلام ۾ مناجات ۽ پرارتھنا جي هڪ صورت آهي. اهي دلي دعائون پنهنجي ۽ بين لاءِ الله جي برڪتون، رهنمائي ۽ رحمت طلب ڪن ٿيون.',
  },
};
...
export default function HamdPage() {
  ...
  const fetchAudio = async () => {
    try {
      const response = await fetch(`/api/audio?language=${language}&category=dua`);
