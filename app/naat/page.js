...
const translations = {
  en: {
    title: 'Naat - Praise of Prophet Muhammad (PBUH)',
    backToHome: 'Back to Home',
    subtitle: 'Beautiful Praises of the Beloved Prophet',
    play: 'Play',
    pause: 'Pause',
    download: 'Download',
    noAudio: 'No Naat available yet',
    description: 'Naat is a form of poetry in praise of Prophet Muhammad (Peace Be Upon Him). These devotional recitations express love and reverence for the final messenger of Allah.',
  },
  ur: {
    title: 'نعت - نبی کریم ﷺ کی مدح',
    backToHome: 'واپس ہوم پیج',
    subtitle: 'حضور ﷺ کی خوبصورت مدح',
    play: 'چلائیں',
    pause: 'روکیں',
    download: 'ڈاؤن لوڈ',
    noAudio: 'ابھی کوئی نعت دستیاب نہیں',
    description: 'نعت نبی کریم ﷺ کی مدح میں شاعری کی ایک صورت ہے۔ یہ عقیدت مند تلاوتیں اللہ کے آخری رسول کے لیے محبت اور احترام کا اظہار کرتی ہیں۔',
  },
  sd: {
    title: 'نعت - نبي ڪريم ﷺ جي مدح',
    backToHome: 'واپس گهر',
    subtitle: 'حضور ﷺ جي سهڻي مدح',
    play: 'هلايو',
    pause: 'روڪيو',
    download: 'ڊائون لوڊ',
    noAudio: 'هاڻي ڪا به نعت موجود ناهي',
    description: 'نعت نبي ڪريم ﷺ جي مدح ۾ شاعري جي هڪ صورت آهي. اهي عقيدت مند تلاوتون الله جي آخري رسول لاءِ محبت ۽ احترام جو اظهار ڪن ٿيون.',
  },
};
...
export default function HamdPage() {
  ...
  const fetchAudio = async () => {
    try {
      const response = await fetch(`/api/audio?language=${language}&category=naat`);
